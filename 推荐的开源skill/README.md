...
> 下面这些是**加分项**——让作品更出彩，但不解决核心问题。核心永远是 [开发流程 + 存档](../开发流程与存档/)。
> 这里只放**链接 + 介绍**，不搬运代码；点进去按各自仓库说明安装即可（注意遵守各自的开源许可证）。

| Skill | 解决什么 | 适合谁 | 链接 |
|---|---|---|---|
| **网页 PPT（guizang-ppt-skill）** | 一句话生成能翻页的网页 PPT（横向/演讲风） | 要做分享 / 演示 / 发抖音 | https://github.com/op7418/guizang-ppt-skill |
